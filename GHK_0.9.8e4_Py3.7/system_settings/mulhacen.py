...
RotL, dRotL, nRotL 	= -5.7, 	0.1, 	1	#alpha; rotation of laser polarization in degrees; default 0
...
ERaT, dERaT, nERaT	 = 1.000, 0.000, 1 # Extinction ratio
RotaT, dRotaT, nRotaT = 0.,   0.,    1 # Rotation of the Pol.-filter in degrees; usually 0° because TP >> TS, but for PollyXTs it can also be 90°
#   --
TiT = 0.5 * (TP + TS)
DiT = (TP-TS)/(TP+TS)
DaT = (1-ERaT)/(1+ERaT)
...
ERaR, dERaR, nERaR	  = 1.00, 0.00, 1 # Extinction ratio
