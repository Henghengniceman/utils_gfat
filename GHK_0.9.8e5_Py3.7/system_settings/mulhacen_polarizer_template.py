...
RotL, dRotL, nRotL 	= alpha_value, alpha_error, 	1	#alpha; rotation of laser polarization in degrees; default 0
...
if TypeC == 1:  #mechanical rotator
	...
	TiC = 0.4	# ideal 0.5
	RetC, dRetC, nRetC 	= 0., 	0., 	0
	RotC, dRotC, nRotC 	= epsilon_value, 	epsilon_error, 	1	#constant calibrator offset epsilon
	RotationErrorEpsilonForNormalMeasurements = True	# 	is in general False for TypeC == 3 calibrator
